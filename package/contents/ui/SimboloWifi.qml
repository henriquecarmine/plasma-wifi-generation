...
Item {
    ...
    //
    // HOUVE um terceiro modo, "mix": o leque com um pontinho no canto inferior
    // esquerdo, para dizer que havia um segundo enlace ativo com gateway
    // próprio. Saiu a pedido do dono — "aquele pontinho não diz nada" — e o
    // pedido está certo: a marca só era legível para quem tivesse lido o
    // código que a desenhou, e a pergunta que se faz olhando a bandeja é
    // "estou no cabo ou no wifi?", que ela não respondia. Quem responde agora
    // é o símbolo inteiro, que troca para o cabo quando é o cabo que carrega a
    // rota padrão; o segundo enlace vai por escrito na dica.
